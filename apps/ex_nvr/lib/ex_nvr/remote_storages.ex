defmodule ExNVR.RemoteStorages do
  ...
  def update(%RemoteStorage{} = remote_storage, params) do
    remote_storage
    |> RemoteStorage.changeset(params)
    |> Repo.update()
  end
  ...
  @spec change_remote_storage(RemoteStorage.t(), map()) :: Ecto.Changeset.t()
  def change_remote_storage(%RemoteStorage{} = remote_storage, attrs \\ %{}) do
    RemoteStorage.changeset(remote_storage, attrs)
  end
end
