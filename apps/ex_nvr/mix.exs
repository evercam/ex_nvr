defmodule ExNVR.MixProject do
  ...
  defp deps do
    [
      ...
      {:swoosh, "~> 1.3"},
      {:finch, "~> 0.13"},
      {:ex_sdp, github: "gBillal/ex_sdp", branch: "add-h265-fmtp-fields", override: true},
      ...
      {:membrane_h265_plugin, "~> 0.3"},
      {:membrane_mp4_plugin,
       github: "gBillal/membrane_mp4_plugin", branch: "support-hvc1-and-hev1", override: true},
