    ...
    <.modal2 id="camera-authentication">
      ...
      <.simple_form id="auth-form" phx-submit="authenticate-device" for={@auth_form} class="space-y-4">
        ...
        <.input
          ...
          placeholder="••••••••"
          label="Your password"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
          required
        />
